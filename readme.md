Objeto Socio: DNI, Nombre, Apellido, Email, Fecha de Nacimiento, Direccion
...
NO PERMITIR ELIMINAR UN LIBRO SI TIENE UN PRESTAMO ACTIVO SOCIOS
CALCULAR CUANTAS CUOTAS DEBE Y EL IMPORTE
AGREGAR DEUDA SI SE VUELVE A CARGAR EL MISMO DNI
